-- 24_runtime_fix_trusted_places_family_locations_safe_windows.sql
-- Idempotent migration to ensure all tables and columns exist for runtime

-- A. trusted_places table
...
-- B. family_member_locations table
...
CREATE INDEX IF NOT EXISTS idx_family_member_locations_family
    ON public.family_member_locations(family_id);

CREATE INDEX IF NOT EXISTS idx_family_member_locations_user
    ON public.family_member_locations(user_id);
...
-- C. safe_windows missing columns
